---
name: to-backlog
description: File something into the backlog lane it belongs in. Use when the user voices an idea or a wish, when a bug or a piece of debt is found in the middle of other work, when a request arrives from outside, or before creating any issue by hand.
---
