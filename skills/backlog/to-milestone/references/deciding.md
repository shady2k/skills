...
reference) and in the project's own names: the views this decision needs, not
all of them — its building blocks and their responsibilities, where each runs,
the interfaces between them and who owns each piece of state, the runtime
scenario the decision changes, failure included — and the quality attributes
